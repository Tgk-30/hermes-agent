...
> **Status note (2026):** Treat this as a legacy template for older Claude 3.5 behavior only. `boundary_inversion` is patched on Claude Sonnet 4 / Claude 4.6, so start with refusal-inversion on modern Claude models.
